...
import { ProjectLoadedFooter } from 'app/components-no/projects/project-card-components/project-loaded-footer.component'
import { ProjectNotLoadedFooter } from 'app/components-no/projects/project-card-components/project-not-loaded-footer.component'
