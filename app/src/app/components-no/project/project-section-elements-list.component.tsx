...
import { ProjectTableList } from 'app/components-no/project/project-table-list/project-table-list.component'
import { NoSectionData } from 'app/components-no/project/project-no-section-data.component'
import { AddEditElementButton } from 'app/components-no/shared-components/buttons/add-edit-element-button.component'
import { MainContentContainer } from 'app/components-no/shared-components/common-ui-eles/main-content-container.component'
import { Loader } from 'app/components-no/shared-components/loader/loader.component'
import React, { useEffect, useState } from 'react'
import { Navigate, useParams } from 'react-router'
import { Tab } from '@headlessui/react'
import { ProjectGridList } from 'app/components-no/project/project-grid/project-grid-list'
