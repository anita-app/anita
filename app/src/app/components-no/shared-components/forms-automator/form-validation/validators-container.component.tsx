...
import { IValidatorsConatinerProps, IValidatorsState } from 'app/components-no/shared-components/forms-automator/form-validation/validators'
import { EmailFormat } from 'app/components-no/shared-components/forms-automator/form-validation/validators/email-format.component'
import { RequiredField } from 'app/components-no/shared-components/forms-automator/form-validation/validators/required-field.component'
import { TelephoneNumber } from 'app/components-no/shared-components/forms-automator/form-validation/validators/telephone-number.component'
import { UrlFormat } from 'app/components-no/shared-components/forms-automator/form-validation/validators/url-format.component'
