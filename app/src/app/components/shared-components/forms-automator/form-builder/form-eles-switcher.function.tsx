...
import type { IBasicRadio, IBasicSelect, ICommonFormEleProps } from 'app/components/shared-components/forms-automator/form-automator.types'
  ...
  switch (codaAsInt) {
    ...
    case FORM_COMPONENTS_CODES.basicSelect:
      return (
        <BasicSelect
          key={key}
          {...props as ICommonFormEleProps<IBasicSelect<ISectionElement>>}
        />
      )
    ...
    case FORM_COMPONENTS_CODES.basicRadio:
      return (
        <BasicRadio
          key={key}
          {...props as ICommonFormEleProps<IBasicRadio<ISectionElement>>}
        />
      )
