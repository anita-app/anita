...
import { BasicText } from 'app/components/project/section/values-renderers/basic-text.component'
import { CheckBoxAsCheck } from 'app/components/project/section/values-renderers/check-box-as-check.component'
import { Color } from 'app/components/project/section/values-renderers/color.component'
import { Email } from 'app/components/project/section/values-renderers/email.component'
import { FormattedDateTime } from 'app/components/project/section/values-renderers/formatted-date-time.component'
import { FormattedDate } from 'app/components/project/section/values-renderers/formatted-date.component'
import { Month } from 'app/components/project/section/values-renderers/month.component'
import { Password } from 'app/components/project/section/values-renderers/password.component'
import { Percentage } from 'app/components/project/section/values-renderers/range.component'
import { Tel } from 'app/components/project/section/values-renderers/tel.component'
import { TextFromOptionsByValue } from 'app/components/project/section/values-renderers/text-from-options-by-value.component'
import { Url } from 'app/components/project/section/values-renderers/url.component'
import { Week } from 'app/components/project/section/values-renderers/week.component'
